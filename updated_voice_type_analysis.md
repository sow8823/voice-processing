...
graph TD
    ...
    C -->|地声傾向かつ非整数次倍音少| E[ミックス候補]
    C -->|地声傾向かつ非整数次倍音多| F[プル確定]
    C -->|中間/裏声判定| G[フリップ確定]
    E --> H[第3音程分析]
    H -->|3kHz強| I[ミックス確定]
    H -->|中間/裏声判定| J[フリップ確定]
...
- スペクトル傾斜が急（-2～-10 dB/oct）→ 地声傾向
- スペクトル傾斜が緩やか（-13～-30 dB/oct）→ 裏声傾向
- その中間(-10～-13) -> 中間傾向

### 4.2 高周波成分の強度による判定（新規追加）

- 2.0kHz以上の高周波成分の中で、基音に対して4分の1以上の強さを持つ成分がある → 地声傾向
- 4分の1以上の強さを持つ成分がない → 裏声傾向

### 4.3 総合判定

- 両方の条件で地声傾向 → 地声
- 4.2で裏声傾向 → 裏声
- 4.2で地声傾向かつ4.1で裏声傾向または中間傾向 → 中間
